...
CREATE TABLE `user` (
  ...
  `TagIds` longtext,
  `IgnoredTagIds` longtext,
  `FollowingUserIds` longtext,
  `Created` datetime DEFAULT NULL,
  `BadgeIds` longtext,
  `Reputation` int(11) NOT NULL DEFAULT '0',
  `HideVisitedArticles` bit(1) NOT NULL DEFAULT b'1',
  `HideOlderThan` varchar(200) DEFAULT NULL,
  `Date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `IsAdmin` bit(1) NOT NULL DEFAULT b'0',
  `LastSeen` datetime DEFAULT NULL,
  `GUID` varchar(200) DEFAULT NULL,
  `Subscribed` bit(1) NOT NULL DEFAULT b'1',
  `SharedOnFacebook` bit(1) DEFAULT b'0',
  `SharedOnTwitter` bit(1) DEFAULT b'0',
  PRIMARY KEY (`Id`)
...
-- Dump completed on 2018-06-07 11:07:04
